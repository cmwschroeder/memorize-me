    ...
    return (
        <div>
            ...
            <div className='app'>
                ...
                <div>
                    <div>
                        <button className=" btn btn-xs sm:btn-sm md:btn-md lg:btn-lg btn-link border-2 mx-2.5 border-error rounded-lg px-3 py-2 text-error cursor-pointer hover:bg-error hover:text-white" >Missed: {clicks}</button>
                        ...
                        <Link to={'/game/' + game._id}><button className='btn btn-xs sm:btn-sm md:btn-md lg:btn-lg btn-link border-2 mx-2.5 border-neutral rounded-lg px-3 py-2 text-neutral cursor-pointer hover:bg-neutral hover:text-accent' onClick={() => sound.stop()}>Reset</button></Link>
                    </div>
